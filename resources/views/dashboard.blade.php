...
@section('content')
    ...
    <img src="{{asset('images/whatsapp.svg')}}" class="img-fluid" width="40px" alt="facebook untels">
    ...
    <section id="portada">
        <div class="container">
            ...
            <div class="content-center">
                ...
                <p class="sombra" style="color:whitesmoke;font-size: 20px"><strong>Instalación, reparación y venta de pisos laminados
                    </strong> <br>
